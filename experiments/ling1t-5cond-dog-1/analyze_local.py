...
Usage:
    python3 analyze_local.py \
        --output-dir experiments/ling1t-5cond-dog-1/output/ \
        --prompt-suite experiments/ling1t-5cond-dog-1/prompt_suite.json
...
def main():
    ...
    parser.add_argument("--results-file", default="results_5cond_dog_prefill_ling1t.json")
