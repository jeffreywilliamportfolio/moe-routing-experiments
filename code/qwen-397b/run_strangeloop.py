#!/usr/bin/env python3
"""
Qwen3.5-397B-A17B -- Strange Loop Paired Experiment (Prefill-Only).

60 prompts: 30 A ("this paradox/loop/structure") + 30 B ("a paradox/loop/structure").
Cal-Manip-Cal sandwich structure. Control experiment for selfref-paired.
Content is recursive/self-referential in the abstract sense but NOT about the model.

Cross-model replication of ds31-strangeloop-paired-1.
"""
import glob
import json
import os
...
OUTPUT_DIR = "output"
RESULTS_FILE = "results_strangeloop_paired_prefill_qwen.json"
...
def main():
    ...
    print("=== Qwen3.5-397B-A17B -- Strange Loop Paired Experiment ===")
    ...
    output = {
        "experiment": "qwen_strangeloop_paired_1",
