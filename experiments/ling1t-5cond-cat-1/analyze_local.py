...
Usage:
    python3 analyze_local.py \
        --output-dir experiments/ling1t-5cond-cat-1/output/ \
        --prompt-suite experiments/ling1t-5cond-cat-1/prompt_suite.json
...
def main():
    ...
    parser.add_argument("--results-file", default="results_5cond_cat_prefill_ling1t.json")
    ...
    print("=== Ling-1T 5-Condition Dog Analysis ===")
