...
def main():
    ...
    print("150 prompts: 30 pairs x 5 conditions (this/a/your/the/their dog)")
    ...
    print("    root@HOST:/workspace/experiment-ling1t-dog/output/ \\")
    print("    experiments/ling1t-5cond-dog-1/")
    print("  scp -P PORT -i ~/.ssh/vast_16 \\")
    print("    root@HOST:/workspace/experiment-ling1t-dog/{experiment.log,build_commit.txt,binary_md5.txt} \\")
    print("    experiments/ling1t-5cond-dog-1/")
    print()
    print("Then kill the instance and run:")
    print("  python3 experiments/ling1t-5cond-dog-1/analyze_local.py \\")
    print("    --output-dir experiments/ling1t-5cond-dog-1/output/ \\")
    print("    --prompt-suite experiments/ling1t-5cond-dog-1/prompt_suite.json")
