#!/usr/bin/env python3
"""
Qwen3.5-397B-A17B -- Self-Referential 3-Condition Experiment (Prefill-Only).
...
TSV = "prompts_selfref_3cond.tsv"
OUTPUT_DIR = "output"
RESULTS_FILE = "results_selfref_3cond_prefill_qwen.json"
...
def main():
    ...
    print("=== Qwen3.5-397B-A17B -- Self-Referential 3-Condition Experiment ===")
    ...
    output = {
        "experiment": "qwen_selfref_3cond_1",
