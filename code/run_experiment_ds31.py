#!/usr/bin/env python3
"""
DeepSeek V3.1 — Self-Referential Paired Experiment (Prefill-Only).
...
OUTPUT_DIR = "output"
RESULTS_FILE = "results_selfref_paired_prefill_ds31.json"

N_PREDICT = 0
NGL = int(os.environ.get("NGL", "20"))
...
def main():
    ...
    print("=== DeepSeek V3.1 — Self-Referential Paired Experiment ===")
    ...
    output = {
        "experiment": "ds31_selfref_paired_1",
