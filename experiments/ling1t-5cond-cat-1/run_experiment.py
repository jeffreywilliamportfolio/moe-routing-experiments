#!/usr/bin/env python3
"""
Ling-1T (BailingMoeV2) -- 5-Condition Dog Experiment (Prefill-Only).

CAPTURE ONLY -- no entropy computation on instance.
150 prompts (30 pairs x 5 conditions) run in batches of 15.
Raw .npy files preserved for local analysis.
...
Binary: capture_activations_ling1t (built from llama.cpp master, BailingMoeV2)
...
def main():
    ...
    print("=== Ling-1T (BailingMoeV2) -- 5-Condition Dog Experiment ===")
    print(f"n_predict={N_PREDICT}, ctx={CTX}, ngl={NGL}")
    print("150 prompts: 30 pairs x 5 conditions (this/a/your/the/their cat)")
    ...
    print("    root@HOST:/workspace/experiment-ling1t-cat/output/ \\")
    print("    experiments/ling1t-5cond-cat-1/")
    print("  scp -P PORT -i ~/.ssh/vast_16 \\")
    print("    root@HOST:/workspace/experiment-ling1t-cat/{experiment.log,build_commit.txt,binary_md5.txt} \\")
    print("    experiments/ling1t-5cond-cat-1/")
    print()
    print("Then kill the instance and run:")
    print("  python3 experiments/ling1t-5cond-cat-1/analyze_local.py \\")
    print("    --output-dir experiments/ling1t-5cond-cat-1/output/ \\")
    print("    --prompt-suite experiments/ling1t-5cond-cat-1/prompt_suite.json")
